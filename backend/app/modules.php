...
return [
    ...
    'settings' => $module('Company settings', 'Publish one company-profile record for shared contact details. Public business information only; never enter passwords or SMTP secrets.', [$title, $summary, $field('email', 'General contact email', 'email'), $field('careers_email', 'Careers email', 'email'), $field('press_email', 'Press email', 'email'), $field('legal_email', 'Legal email', 'email'), $field('investors_email', 'Investor relations email', 'email'), $field('phone', 'Contact phone'), $field('address', 'Operating address', 'textarea'), $field('registered_address', 'Registered address', 'textarea'), $field('business_hours', 'Business hours'), $field('website', 'Main website', 'url'), $field('linkedin', 'LinkedIn profile', 'url'), $field('facebook', 'Facebook profile', 'url'), $field('youtube', 'YouTube channel', 'url'), $field('x', 'X profile', 'url'), $image]),
];
