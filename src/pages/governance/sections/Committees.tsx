...
export default function Committees({ c }: { c: GovernanceContent['committees'] }) {
  return (
    <section className="bg-navy-dark border-y border-white/8 dcards">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6 dcards__grid">
          {c.items.map((item, i) => (
            <div key={item.name} className="border border-white/8 rounded-xl p-8 bg-navy/60 hover:border-gold/20 transition-colors dcard group" onPointerMove={spotlight}>
              ...
              <div className="pt-4 border-t border-white/8 gov-mandate">
                <span className="font-mono text-[11px] tracking-[0.16em] uppercase text-slate-500">{c.mandateLabel}</span>
