...
export const process: EShipeContent["process"] = [
  ...
  },
  {
    ...
    desc: "সনদপ্রাপ্ত মেরিন সার্ভেয়ারের মাধ্যমে স্বতন্ত্র সার্ভে পরিচালিত হয়। হাল, মেশিনারি ও ক্লাস স্ট্যাটাস সহ পূর্ণাঙ্গ কন্ডিশন রিপোর্ট প্রদান করা হয়।",
  },
  {
...
export const whyItems: EShipeContent["why"]["items"] = [
  {
    icon: "◈",
    title: "বৈশ্বিক ক্রেতা নেটওয়ার্ক",
    desc: "৫০+ দেশে ২০০+ নিবন্ধিত ক্রেতা — প্রাতিষ্ঠানিক বিনিয়োগকারী, শিপিং লাইন ও স্বতন্ত্র অপারেটর সহ।",
    color: OCEAN,
  },
  {
    icon: "◈",
  ...
  },
  {
    icon: "◈",
    title: "আইনি সহায়তা",
    desc: "MOA প্রস্তুতি, ফ্ল্যাগ ট্রান্সফার সমন্বয় ও পোর্ট এজেন্ট সেবা — N71-এর বৈশ্বিক আইনি নেটওয়ার্কের মাধ্যমে পরিচালিত।",
    color: "var(--accent-amber)",
  },
  {
    icon: "◈",
    title: "সনদপ্রাপ্ত সার্ভেয়ার",
    desc: "সকল প্রধান বন্দরে স্বতন্ত্র সার্ভে অংশীদার উপলব্ধ। ক্লাস-অনুমোদিত, IIMS-সংযুক্ত ও শিল্প-স্বীকৃত।",
    color: OCEAN,
  },
  {
    icon: "◈",
