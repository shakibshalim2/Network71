...
const benefits = [
  ...
  },
  {
    ...
    desc: "Work across 25+ countries and collaborate with international teams on real-world projects.",
    icon: (
      <svg className="w-6 h-6 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
...
const openings = [
  { title: "Operations Manager", division: "Global Trading", location: "Dhaka, Bangladesh" },
  { title: "Software Engineer", division: "IT & Software", location: "Dhaka / Remote" },
  { title: "Supply Chain Analyst", division: "Agriculture & Agro", location: "Dhaka, Bangladesh" },
  { title: "Business Development Manager", division: "Garments & Apparel", location: "Dhaka, Bangladesh" },
  { title: "Finance Analyst", division: "Corporate", location: "Dhaka, Bangladesh" },
  { title: "Digital Marketing Specialist", division: "IT & Software", location: "Remote" },
]

const hiringSteps = [
  { step: "01", title: "Apply", desc: "Send your CV to careers@network71.com or hit Apply on any listing." },
  { step: "02", title: "Review", desc: "Our team reviews your application within 5–7 business days." },
  { step: "03", title: "Interview", desc: "Up to two interview rounds — one with HR, one with the hiring manager." },
  { step: "04", title: "Offer", desc: "Successful candidates receive a formal offer and onboarding plan." },
]

const testimonials = [
  {
    quote: "Joining Network71 was a turning point. The scale of operations gave me exposure I simply could not have found anywhere else in Bangladesh.",
    name: "[Name Withheld]",
    division: "Global Trading",
    since: "Since 2021",
  },
  {
    quote: "The culture here genuinely values fresh ideas. I pitched a process improvement in my second month and it was implemented within weeks.",
    name: "[Name Withheld]",
    division: "IT & Software",
    since: "Since 2022",
  },
  {
    quote: "Working across multiple divisions showed me the full picture of how a multinational really operates. The learning curve was steep and absolutely worth it.",
    name: "[Name Withheld]",
    division: "Agriculture & Agro",
    since: "Since 2020",
  },
]
      ...
      <section className="relative bg-navy pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-slate-300 text-xl max-w-xl leading-relaxed">
            Join a team of driven professionals working across eight sectors in 25+ countries. Shape the future of emerging markets from day one.
          </p>
          <div className="mt-10">
            <a
      ...
      <section className="bg-navy-dark py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
            {benefits.map((b) => (
              <div key={b.title} className="bg-navy border border-white/8 rounded-2xl p-8 hover:border-gold/25 transition-colors duration-300 group">
      ...
      <section className="bg-navy py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {openings.map((job) => (
              <div key={job.title} className="bg-navy-dark border border-white/8 rounded-2xl p-8 flex items-start justify-between gap-6 hover:border-gold/25 transition-colors duration-300 group">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500">Salary: Competitive</p>
                </div>
                <a
      ...
      <section className="bg-navy-dark py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {hiringSteps.map((s, i) => (
              <div key={s.step} className="relative bg-navy border border-white/8 rounded-2xl p-8 hover:border-gold/25 transition-colors duration-300">
              ...
              <div key={i} className="bg-navy-dark border border-white/8 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-white/8">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs">{t.division} · {t.since}</p>
                  </div>
                </div>
              </div>
            ))}
