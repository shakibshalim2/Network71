...
version: 1.0.0
description: 'Process audio: separate vocals/voice from music or extract any stem
  by text prompt (e.g. ''singing voice'', ''piano'', ''drums''; returns the extracted
  track plus the residual), remove background noise to isolate clean speech, or enhance
  quality via super-resolution.'
metadata:
  category: general
  requires:
    bins:
...
Process audio: separate vocals/voice from music or extract any stem by text prompt (e.g. 'singing voice', 'piano', 'drums'; returns the extracted track plus the residual), remove background noise to isolate clean speech, or enhance quality via super-resolution.
